...
const Tearms = () => {
  return (
    <div>
        <Head>
        <title>Watch Movies Online™ Terms of Service</title>
...
<meta name="revisit-after" content="1 days" />
  ...
  <link rel="alternate" hrefLang="en-us" 	href="https://crimemagazine.vercel.app/"/>
	<link rel="alternate" hrefLang="en-gb" 	href="https://crimemagazine.vercel.app/"/>
	<link rel="alternate" hrefLang="en-ca" 	href="https://crimemagazine.vercel.app/"/>
	<link rel="alternate" hrefLang="en-au" 	href="https://crimemagazine.vercel.app/"/>
	<link rel="alternate" hrefLang="en-se" 	href="https://crimemagazine.vercel.app/"/>
	<link rel="alternate" hrefLang="en-fr" 	href="https://crimemagazine.vercel.app/"/>
	<link rel="alternate" hrefLang="en-dk" 	href="https://crimemagazine.vercel.app/"/>
	<link rel="alternate" hrefLang="en-no" 	href="https://crimemagazine.vercel.app/"/>
	<link rel="alternate" hrefLang="x-default" 	href="https://crimemagazine.vercel.app/"/>
      </Head>
{/* <Script src="../../propler/ads.js" defer /> */}
  ...
  <div className="flex flex-wrap">
    <div className="grow-0 shrink-0 basis-auto mb-12 md:mb-0 w-full  px-3 lg:px-6">
      ...
      <p className="font-bold mb-2">Using Watch Movies Online</p>
      <p className="text-gray-500 mb-6">
      When you enter Watch Movies Online you automatically agree to all our rules and regulations!
      </p>
      ...
      <p className="text-gray-500 mb-6">
      Watch Movies Online is not responsible for anything that might happen on third-party websites. We are not responsible for the accuracy, compliance, copyright, legality, decency, or any other aspect of the content of other linked sites. Please, be careful when you install, download or submit any personal or CC information!
      </p>

     
      <p className="text-gray-500">
      Watch Movies Online holds no responsibility for any legal or copyright issues that may occur due to the use of Watch Movies Onlinemovie. Please check local copyright laws or the rules of your provider to avoid legal problems.
      </p>
    </div>
...
<section className="mb-32 text-gray-800">
  <div className="flex flex-wrap">
    <div className="grow-0 shrink-0 basis-auto mb-12 md:mb-0 w-full  px-3 lg:px-6">
      ...
      <p className="font-bold mb-2">Why is a Video is not loading?</p>
      <p className="text-gray-500 mb-6">
      ...
      <p className="text-gray-500 mb-6">Another reason why videos won’t play is because your browser is outdated. Updating your browser to the latest version should resolve the problem, since the updated browser may have already been optimized and fixed for previously reported bugs.</p>
      <p className="font-bold mb-2">Why isn't there a HD version of this video?</p>
      <p className="text-gray-500 mb-6">
      The next factor you need to look at is the quality of the video you are playing. Some videos might be too big for your internet connection, so your browser will have trouble loading it.</p>
      <p className="text-gray-500 mb-6">
To adjust the video quality:</p>
<p className="text-gray-500 mb-6">
1.Click the gear icon located at the bottom of the video you want to play.</p>

<p className="text-gray-500 mb-6">2.Choose the lowest quality available to check if the video will play.</p>
<p className="text-gray-500 mb-6">
3.If it plays , try raising the quality bit by bit until you find the highest quality your internet connection is capable of streaming.
      ...
      <p className="text-gray-500 mb-6">
     Just Follow these steps and we handel the rest.</p>
     <p className="text-gray-500 mb-6">
							1.Commit to Sharing Less Online.</p>
              <p className="text-gray-500 mb-6">
							2.Use Strong, Unique Passwords and Two-Factor Authentication (No SMS)</p>
              <p className="text-gray-500 mb-6">
							3.Tighten Privacy Settings for Your Online Accounts.</p>
              <p className="text-gray-500 mb-6">
							4.Purge Unused Mobile Apps and Browser Extensions.</p>
              <p className="text-gray-500 mb-6">
							5.Block Search Engines From Tracking You.</p>
              <p className="text-gray-500 mb-6">
							6.Browse Online With a Secure VPN.</p>
